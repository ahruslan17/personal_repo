...
class NewListingsParser:
    ...
    def writeIntoDataBase(self, news_title, ticker, release_date, listing_date, listing_type, prior_exchange, market):
        ...
        listing_data = [(news_title, ticker, release_date, listing_date_timestamp, listing_type, prior_exchange, market)]

        insert_query = '''
        INSERT INTO newListings
        (news_title, ticker, release_date, listing_date, listing_type, prior_exchange, market) 
    ...
    def master_parser(self):
        try:
            ...
            if response.status_code == 200:
                ...
                if articles_json != self.previous_articles:
                    ...
                    try:
                        ...
                        asyncio.run(self.send_telegram_message(f"Произошла ошибка: {e}."))
            ...
            asyncio.run(self.send_telegram_message(f'master_parser Error {e}'))
...
#         return -11
    ...
    def main(self):
        ...
        try:
            asyncio.run(self.send_telegram_message('Парсер New Listings запущен.'))
            ...
            # pa = '[{"id":181836,"code":"b8ace6ade44740e6afc21a3e355fdac1","title":"Binance Adds TIA, SNT, STEEM and More Pairs on Cross Margin \u0026 Isolated Margin","type":1,"releaseDate":1698918303755}, {"id":183310,"code":"104db5d54d024410bfb3ec21b33aa010","title":"Binance Adds ACA, AMP, GHST \u0026 More Pairs on Cross Margin and Isolated Margin","type":1,"releaseDate":1700187322012}, {"id":181951,"code":"d047f1923f8a40be8aedcc74387f09dc","title":"Binance Futures Will Launch USDⓈ-M TOKEN Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1699008602884},{"id":181934,"code":"afcf1ccc7978458d8474f500da91a00d","title":"Binance Futures Will Launch USDⓈ-M MEME Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1699003203190},{"id":181878,"code":"a45e7c4a2ca44921b13da66f291e22b8","title":"Binance Futures Will Launch USDⓈ-M TWT Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698988203438},{"id":181836,"code":"b8ace6ade44740e6afc21a3e355fdac1","title":"Binance Adds TIA, SNT, STEEM and More Pairs on Cross Margin \u0026 Isolated Margin","type":1,"releaseDate":1698918303755},{"id":181807,"code":"b8163f2f29654c2eb758d576bef95515","title":"Binance Will Open Trading for Memecoin (MEME)","type":1,"releaseDate":1698912078594},{"id":181791,"code":"a33e70c5215841299b4d4614918b93a5","title":"Binance Futures Will Launch USDⓈ-M CAKE Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698910232851},{"id":181727,"code":"2e53db8e7af34d7dae7310e4a4336cdd","title":"Binance Futures Will Launch USDⓈ-M SNT Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698892513670},{"id":181528,"code":"5e5eab2a19d444898e6961ba33d04849","title":"Binance Futures Will Launch USDⓈ-M TIA Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698768499741},{"id":181463,"code":"5d8c7476197344d087b5af436bfc74ae","title":"Binance Futures Will Launch USDⓈ-M SLP Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698731158402},{"id":181434,"code":"4492f05f8b0e40f2a6dc9321aba0ba27","title":"Binance Will List Celestia (TIA) with Seed Tag Applied","type":1,"releaseDate":1698671932206},{"id":181387,"code":"8e7a24082b4f4ab39229b05cadbfce0a","title":"Binance Adds ACA, GHST, VIDT and More Pairs on Cross Margin \u0026 Isolated Margin","type":1,"releaseDate":1698638428354},{"id":181301,"code":"90ccca2c5d6946ef9439dae41a517578","title":"Introducing Memecoin (MEME) on Binance Launchpool! Farm MEME by Staking BNB, TUSD and FDUSD","type":1,"releaseDate":1698415749172},{"id":181213,"code":"c40a1707de63466f9aa14fd046c75e81","title":"Binance Futures Will Launch USDⓈ-M POWR Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1698321002985},{"id":180971,"code":"6cdb1faca0e44c188ab680494c3bfa11","title":"Notice on New Trading Pairs \u0026 Trading Bots Services on Binance Spot - 2023-10-26","type":1,"releaseDate":1698204603826},{"id":180905,"code":"d8b596b131b64130940798961d73a8b5","title":"Binance Futures Will Launch USDⓈ-M POLYX and GAS Perpetual Contracts With Up to 50x Leverage","type":1,"releaseDate":1698151948683},{"id":180616,"code":"cdeaa008a1484ba0974f4359a31d29c3","title":"Binance Futures Will Launch USDⓈ-M RIF Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1697862003215},{"id":180345,"code":"21802d4be7ce4e4a880e2990a6775422","title":"Binance Futures Will Launch USDⓈ-M BSV Perpetual Contract With Up to 50x Leverage","type":1,"releaseDate":1697771703998},{"id":180281,"code":"afd04e47bab84bdab855f7698bf40fb5","title":"Binance Adds ARK, OMG \u0026 More Pairs on Cross Margin \u0026 Isolated Margin","type":1,"releaseDate":1697688013854},{"id":180188,"code":"b68013d4a1b14c82bb019eabcc13391a","title":"Notice on New Trading Pairs \u0026 Trading Bots Services on Binance Spot - 2023-10-19","type":1,"releaseDate":1697612405894}]'
            ...
            # TODO. Почему мы хард кодим предыдущие статьи, а не берем их из базы?
            ...
            while True:
                ...
                while attempts < max_attempts:
                    try:
                        ...
                        asyncio.run(self.send_telegram_message(f"Ошибка master_parser в main: {e}"))
            ...
            asyncio.run(self.send_telegram_message("Парсер новостей остановлен вручную"))

        except Exception as e:
            print(f"Произошла ошибка в main: {e}")
            logging.info(f"Произошла ошибка: {e}. Парсер новостей остановлен.")
            asyncio.run(self.send_telegram_message(f"Произошла ошибка : {e}. Парсер новостей остановлен."))
